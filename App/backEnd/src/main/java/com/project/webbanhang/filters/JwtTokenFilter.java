	...
	public class JwtTokenFilter extends OncePerRequestFilter{
		...
		private boolean isByPassToken(@NonNull HttpServletRequest request) {
			...
			byPassTokens.add(Pair.of("/api/momo", "POST"));
			// user login, register, forgot-password, verify-otp
			byPassTokens.add(Pair.of(String.format("%s/users/login",apiPrefix), "POST"));
			byPassTokens.add(Pair.of(String.format("%s/users/register",apiPrefix), "POST"));
			byPassTokens.add(Pair.of(String.format("%s/users/forgot-password",apiPrefix), "POST"));
			byPassTokens.add(Pair.of(String.format("%s/users/verify-otp",apiPrefix), "POST"));
			// goong
			byPassTokens.add(Pair.of(String.format("%s/location",apiPrefix), "GET"));
