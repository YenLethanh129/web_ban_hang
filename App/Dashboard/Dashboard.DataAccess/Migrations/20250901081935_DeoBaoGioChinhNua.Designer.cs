...
namespace Dashboard.DataAccess.Migrations
{
    ...
    [Migration("20250901081935_DeoBaoGioChinhNua")]
    partial class DeoBaoGioChinhNua
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dashboard.DataAccess.Models.Entities.BranchIngredientInventory", b =>
                {
                    ...
                    b.Property<DateTime?>("LastTransferDate")
                        ...
                        .HasColumnName("last_transfer_date");
            ...
            modelBuilder.Entity("Dashboard.DataAccess.Models.Entities.IngredientTransferRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ingredient_transfer_requests");
                });

            modelBuilder.Entity("Dashboard.DataAccess.Models.Entities.IngredientTransferRequestDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<decimal>("TransferredQuantity")
                        .HasColumnType("decimal(18, 2)")
                        .HasColumnName("transferred_quantity");
                    ...
                    b.ToTable("ingredient_transfer_request_details");
                });
            ...
            modelBuilder.Entity("Dashboard.DataAccess.Models.Entities.IngredientTransferRequest", b =>
                {
                    b.HasOne("Dashboard.DataAccess.Models.Entities.Branch", "Branch")
                        .WithMany("IngredientTransferRequests")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dashboard.DataAccess.Models.Entities.IngredientTransferRequestDetail", b =>
                {
                    ...
                    b.HasOne("Dashboard.DataAccess.Models.Entities.IngredientTransferRequest", "TransferRequest")
                        .WithMany("TransferRequestDetails")
            ...
            modelBuilder.Entity("Dashboard.DataAccess.Models.Entities.IngredientWarehouse", b =>
                {
                    b.HasOne("Dashboard.DataAccess.Models.Entities.Ingredient", "Ingredient")
                        .WithOne("IngredientWarehouse")
                        .HasForeignKey("Dashboard.DataAccess.Models.Entities.IngredientWarehouse", "IngredientId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Dashboard.DataAccess.Models.Entities.Branch", b =>
                {
                    ...
                    b.Navigation("IngredientTransferRequests");
            ...
            modelBuilder.Entity("Dashboard.DataAccess.Models.Entities.Ingredient", b =>
                {
                    ...
                    b.Navigation("IngredientWarehouse");
                    ...
                    b.Navigation("TransferRequestDetails");
                });
