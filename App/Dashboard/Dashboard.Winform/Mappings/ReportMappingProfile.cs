...
public class ReportMappingProfile : Profile
{
    public ReportMappingProfile()
    {
        CreateMap<DashboardSummaryDto, MainDashboardModel>()
            .ForMember(dest => dest.TodayRevenue, opt => opt.MapFrom(src => src.TodayRevenue))
            .ForMember(dest => dest.MonthlyRevenue, opt => opt.MapFrom(src => src.MonthlyRevenue))
            .ForMember(dest => dest.YearlyRevenue, opt => opt.MapFrom(src => src.YearlyRevenue))
            .ForMember(dest => dest.TodayProfit, opt => opt.MapFrom(src => src.TodayProfit))
            .ForMember(dest => dest.MonthlyProfit, opt => opt.MapFrom(src => src.MonthlyProfit))
            .ForMember(dest => dest.YearlyProfit, opt => opt.MapFrom(src => src.YearlyProfit))
            .ForMember(dest => dest.TodayExpenses, opt => opt.MapFrom(src => src.TodayExpenses))
            .ForMember(dest => dest.MonthlyExpenses, opt => opt.MapFrom(src => src.MonthlyExpenses))
            .ForMember(dest => dest.YearlyExpenses, opt => opt.MapFrom(src => src.YearlyExpenses))
