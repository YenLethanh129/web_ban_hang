...
# dotnet ef migrations add AddRecipe --project App/Dashboard/Dashboard.DataAccess --startup-project App/Dashboard/Dashboard.API --output-dir Data/Migrations
# dotnet ef database update --project App/Dashboard/Dashboard.DataAccess --startup-project App/Dashboard/Dashboard.API
